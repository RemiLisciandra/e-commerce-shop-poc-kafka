        ...
        sql="""
            ...
            DO $$ BEGIN
                IF EXISTS (
                    ...
                    WHERE table_schema = 'staging' AND table_name = 'admins'
                ) THEN
    ...
    load_items = PostgresOperator(
        ...
        sql="""
            ...
            DO $$ BEGIN
                IF EXISTS (
                    SELECT FROM information_schema.tables
                    WHERE table_schema = 'staging' AND table_name = 'items'
                ) THEN
    ...
    load_order_items = PostgresOperator(
        ...
        sql="""
            ...
            DO $$ BEGIN
                IF EXISTS (
                    SELECT FROM information_schema.tables
                    WHERE table_schema = 'staging' AND table_name = 'order_items'
                ) THEN
    ...
    load_payments = PostgresOperator(
        ...
        sql="""
            ...
            DO $$ BEGIN
                IF EXISTS (
                    SELECT FROM information_schema.tables
                    WHERE table_schema = 'staging' AND table_name = 'payments'
                ) THEN
    ...
    load_invoices = PostgresOperator(
        ...
        sql="""
            ...
            DO $$ BEGIN
                IF EXISTS (
                    SELECT FROM information_schema.tables
                    WHERE table_schema = 'staging' AND table_name = 'invoices'
                ) THEN
